import time
from tools_stable.class_barrier_call import Up_and_out_call, risk_return_barrier_call, gamma_test_barrier_call
import numpy as np
...
time0 = time.time()
result_file = open("results/2/result_2.txt", mode="w")
...
if os.path.isfile("results/2/MC.pickle"):
    mean_total, sd_total, mean_cost, sd_cost, mean_slippage, sd_slippage = pickle.load(
        open("results/2/MC.pickle", "rb"))
else:
    mean_total, sd_total, mean_cost, sd_cost, mean_slippage, sd_slippage = risk_return_barrier_call(
        100.0, 0.05, 0.25, 0.05, 1, 100.0, 200, 0.01)
    pickle.dump((mean_total, sd_total, mean_cost, sd_cost,
                mean_slippage, sd_slippage), open("results/2/MC.pickle", "wb"))
...
if os.path.isfile("results/2/MC_1.pickle"):
    mean_total_1, sd_total_1, mean_cost_1, sd_cost_1, mean_slippage_1, sd_slippage_1 = pickle.load(
        open("results/2/MC_1.pickle", "rb"))
else:
    mean_total_1, sd_total_1, mean_cost_1, sd_cost_1, mean_slippage_1, sd_slippage_1 = risk_return_barrier_call(
        100.0, 0.05, 0.25, 0.05, 1, 100.0, 200, 0.05)
    pickle.dump((mean_total_1, sd_total_1, mean_cost_1, sd_cost_1,
                mean_slippage_1, sd_slippage_1), open("results/2/MC_1.pickle", "wb"))
print("high_tc")

# low tc


if os.path.isfile("results/2/MC_2.pickle"):
    mean_total_2, sd_total_2, mean_cost_2, sd_cost_2, mean_slippage_2, sd_slippage_2 = pickle.load(
        open("results/2/MC_2.pickle", "rb"))
else:
    mean_total_2, sd_total_2, mean_cost_2, sd_cost_2, mean_slippage_2, sd_slippage_2 = risk_return_barrier_call(
        100.0, 0.05, 0.25, 0.05, 1, 100.0, 200, 0.002)
    pickle.dump((mean_total_2, sd_total_2, mean_cost_2, sd_cost_2,
                mean_slippage_2, sd_slippage_2), open("results/2/MC_2.pickle", "wb"))
...
# plt.show()
plt.savefig('images/2/risk_return_k_call.png')
plt.close()
...
plt.savefig('images/2/mc_k_call.png')
plt.close()
...
plt.xlabel("$N_S$")
plt.ylabel("sd_cost")
plt.savefig('images/2/sc_k_call.png')
plt.close()
...
plt.savefig('images/2/sl_k_call.png')
plt.close()
...
plt.savefig('images/2/ml_k_call.png')
plt.close()
...
plt.savefig('images/2/corr_k_call.png')
plt.close()
...
if os.path.isfile("results/2/MC_3.pickle"):
    mean_total_3, sd_total_3, mean_cost_3, sd_cost_3, mean_slippage_3, sd_slippage_3 = pickle.load(
        open("results/2/MC_3.pickle", "rb"))
else:
    mean_total_3, sd_total_3, mean_cost_3, sd_cost_3, mean_slippage_3, sd_slippage_3 = risk_return_barrier_call(
        100.0, 0.05, 0.1, 0.05, 1, 100.0, 200, 0.01)
    pickle.dump((mean_total_3, sd_total_3, mean_cost_3, sd_cost_3,
                mean_slippage_3, sd_slippage_3), open("results/2/MC_3.pickle", "wb"))


print("low_vol")
# high vol
if os.path.isfile("results/2/MC_4.pickle"):
    mean_total_4, sd_total_4, mean_cost_4, sd_cost_4, mean_slippage_4, sd_slippage_4 = pickle.load(
        open("results/2/MC_4.pickle", "rb"))
else:
    mean_total_4, sd_total_4, mean_cost_4, sd_cost_4, mean_slippage_4, sd_slippage_4 = risk_return_barrier_call(
        100.0, 0.05, 0.5, 0.05, 1, 100.0, 200, 0.01)
    pickle.dump((mean_total_4, sd_total_4, mean_cost_4, sd_cost_4,
                mean_slippage_4, sd_slippage_4), open("results/2/MC_4.pickle", "wb"))
...
plt.xlabel("sd_total")
plt.ylabel("mean_total")
plt.savefig('images/2/risk_return_v_call.png')
plt.close()
...
plt.savefig('images/2/mc_v_call.png')
plt.close()
...
plt.xlabel("$N_S$")
plt.ylabel("sd_cost")
plt.savefig('images/2/sc_v_call.png')
plt.close()
...
plt.xlabel("$N_S$")
plt.ylabel("mean_slippage")
plt.savefig('images/2/ml_v_call.png')
plt.close()
...
plt.savefig('images/2/sl_v_call.png')
plt.close()
...
plt.xlabel("$N_S$")
plt.ylabel("corr_coef")
plt.savefig('images/2/corr_v_call.png')
plt.close()
...
if os.path.isfile("results/2/MC_5.pickle"):
    mean_total_5, sd_total_5, mean_cost_5, sd_cost_5, mean_slippage_5, sd_slippage_5 = pickle.load(
        open("results/2/MC_5.pickle", "rb"))
else:
    mean_total_5, sd_total_5, mean_cost_5, sd_cost_5, mean_slippage_5, sd_slippage_5 = risk_return_barrier_call(
        100.0, 0.05, 0.25, 0.05, 1, 100.0, 175, 0.01)
    pickle.dump((mean_total_5, sd_total_5, mean_cost_5, sd_cost_5,
                mean_slippage_5, sd_slippage_5), open("results/2/MC_5.pickle", "wb"))

print("low_vol")
# HIGH BARRIER


if os.path.isfile("results/2/MC_6.pickle"):
    mean_total_6, sd_total_6, mean_cost_6, sd_cost_6, mean_slippage_6, sd_slippage_6 = pickle.load(
        open("results/2/MC_6.pickle", "rb"))
else:
    mean_total_6, sd_total_6, mean_cost_6, sd_cost_6, mean_slippage_6, sd_slippage_6 = risk_return_barrier_call(
        100.0, 0.05, 0.25, 0.05, 1, 100.0, 225, 0.01)
    pickle.dump((mean_total_6, sd_total_6, mean_cost_6, sd_cost_6,
                mean_slippage_6, sd_slippage_6), open("results/2/MC_6.pickle", "wb"))
print("high_vol")
...
plt.legend(["H=175", "H=200", "H=225"], loc='upper left')

plt.xlabel("sd_total")
plt.ylabel("mean_total")
plt.savefig('images/2/risk_return_b_call.png')
plt.close()
...
plt.savefig('images/2/mc_b_call.png')
plt.close()
...
plt.xlabel("$N_S$")
plt.ylabel("sd_cost")
plt.savefig('images/2/sc_b_call.png')
plt.close()
...
plt.xlabel("$N_S$")
plt.ylabel("mean_slippage")
plt.savefig('images/2/ml_b_call.png')
plt.close()
...
plt.savefig('images/2/sl_b_call.png')
plt.close()
...
plt.xlabel("$N_S$")
plt.ylabel("corr_coef")
plt.savefig('images/2/corr_b_call.png')
plt.close()
...
plt.savefig('images/2/cost_func_call.png')
plt.close()
...
plt.xlabel("$N_S$")
plt.ylabel("Value of both criteria")
plt.savefig('images/2/cost_func_1_call.png')
plt.close()
...
plt.xlabel("$N_S$")
plt.ylabel("Value of both criteria")
plt.savefig('images/2/cost_func_2_call.png')
plt.close()
...
plt.xlabel("$N_S$")
plt.ylabel("Value of both criteria")
plt.savefig('images/2/cost_func_3_call.png')
plt.close()
...
plt.xlabel("$N_S$")
plt.ylabel("Value of both criteria")
plt.savefig('images/2/cost_func_4_call.png')
plt.close()
...
plt.xlabel("$N_S$")
plt.ylabel("Value of both criteria")
plt.savefig('images/2/cost_func_5_call.png')
plt.close()
...
plt.xlabel("$N_S$")
plt.ylabel("Value of both criteria")
plt.savefig('images/2/cost_func_6_call.png')
plt.close()
...
plt.legend()
plt.savefig('images/2/op_dt_call.png')
plt.close()
...
y_closed = np.zeros(7)
y_gamma_0 = np.zeros(7)
y_gamma_aprox = np.zeros(7)

# default

option = Up_and_out_call(100.0, 0.05, 0.25, 0.05, 1,
                         100.0, 200, 0.01, 1000, 1, 200000)


if os.path.isfile("results/2/gamma.pickle"):
    gamma_abs, gamma_square = pickle.load(open("results/2/gamma.pickle", "rb"))
else:
    gamma_abs, gamma_square = gamma_test_barrier_call(
        100.0, 0.05, 0.25, 0.05, 1, 100.0, 200, 0.01)
    pickle.dump((gamma_abs, gamma_square), open(
        "results/2/gamma.pickle", "wb"))
...
plt.savefig('images/2/mean_aprox_1_call.png')
plt.close()
...
plt.legend(["Path MC", "Gamma MC", "Gamma", "Gamma avg"])
plt.savefig('images/2/sd_aprox_1_call.png')
plt.close()
print("0")
...
####################
# high tc
option1 = Up_and_out_call(100.0, 0.05, 0.25, 0.05, 1,
                          100.0, 200, 0.05, 1000, 1, 200000)


if os.path.isfile("results/2/gamma_1.pickle"):
    gamma_abs_1, gamma_square_1 = pickle.load(
        open("results/2/gamma_1.pickle", "rb"))
else:
    gamma_abs_1, gamma_square_1 = gamma_test_barrier_call(
        100.0, 0.05, 0.25, 0.05, 1, 100.0, 200, 0.05)
    pickle.dump((gamma_abs_1, gamma_square_1),
                open("results/2/gamma_1.pickle", "wb"))
...
plt.legend(["Path MC", "Gamma MC", "Gamma", "Gamma avg"])
plt.savefig('images/2/mean_aprox_2_call.png')
plt.close()
...
plt.legend(["Path MC", "Gamma MC", "Gamma", "Gamma avg"])
plt.savefig('images/2/sd_aprox_2_call.png')
plt.close()
print("gamma_2")

# low tc
option2 = Up_and_out_call(100.0, 0.05, 0.25, 0.05, 1,
                          100.0, 200, 0.002, 1000, 1, 200000)


if os.path.isfile("results/2/gamma_2.pickle"):
    gamma_abs_2, gamma_square_2 = pickle.load(
        open("results/2/gamma_2.pickle", "rb"))
else:
    gamma_abs_2, gamma_square_2 = gamma_test_barrier_call(
        100.0, 0.05, 0.25, 0.05, 1, 100.0, 200, 0.002)

    pickle.dump((gamma_abs_2, gamma_square_2),
                open("results/2/gamma_2.pickle", "wb"))
...
plt.legend(["Path MC", "Gamma MC", "Gamma", "Gamma avg"])
plt.savefig('images/2/mean_aprox_3_call.png')
plt.close()
...
plt.legend(["Path MC", "Gamma MC", "Gamma", "Gamma avg"])
plt.savefig('images/2/sd_aprox_3_call.png')
plt.close()
###############
# VOL
###############
option3 = Up_and_out_call(100.0, 0.05, 0.1, 0.05, 1,
                          100.0, 200, 0.01, 1000, 1, 200000)


# low vol

if os.path.isfile("results/2/gamma_3.pickle"):
    gamma_abs_3, gamma_square_3 = pickle.load(
        open("results/2/gamma_3.pickle", "rb"))
else:
    gamma_abs_3, gamma_square_3 = gamma_test_barrier_call(
        100.0, 0.05, 0.1, 0.05, 1, 100.0, 200, 0.01)

    pickle.dump((gamma_abs_3, gamma_square_3),
                open("results/2/gamma_3.pickle", "wb"))
...
plt.legend(["Path MC", "Gamma MC", "Gamma", "Gamma avg"])
plt.savefig('images/2/mean_aprox_4_call.png')
plt.close()
...
plt.legend(["Path MC", "Gamma MC", "Gamma", "Gamma avg"])
plt.savefig('images/2/sd_aprox_4_call.png')
plt.close()
print("4")
...
# high vol
option4 = Up_and_out_call(100.0, 0.05, 0.5, 0.05, 1,
                          100.0, 200, 0.01, 1000, 1, 200000)

if os.path.isfile("results/2/gamma_4.pickle"):
    gamma_abs_4, gamma_square_4 = pickle.load(
        open("results/2/gamma_4.pickle", "rb"))
else:
    gamma_abs_4, gamma_square_4 = gamma_test_barrier_call(
        100.0, 0.05, 0.5, 0.05, 1, 100.0, 200, 0.01)

    pickle.dump((gamma_abs_4, gamma_square_4),
                open("results/2/gamma_4.pickle", "wb"))
...
plt.legend(["Path MC", "Gamma MC", "Gamma", "Gamma avg"])
plt.savefig('images/2/mean_aprox_5_call.png')
plt.close()
...
plt.savefig('images/2/sd_aprox_5_call.png')
plt.close()
...
# low barrier
option5 = Up_and_out_call(100.0, 0.05, 0.25, 0.05, 1,
                          100.0, 175, 0.05, 1000, 1, 200000)


if os.path.isfile("results/2/gamma_5.pickle"):
    gamma_abs_5, gamma_square_5 = pickle.load(
        open("results/2/gamma_5.pickle", "rb"))
else:
    gamma_abs_5, gamma_square_5 = gamma_test_barrier_call(
        100.0, 0.05, 0.25, 0.05, 1, 100.0, 175, 0.01)

    pickle.dump((gamma_abs_5, gamma_square_5),
                open("results/2/gamma_5.pickle", "wb"))
...
plt.legend(["Path MC", "Gamma MC", "Gamma", "Gamma avg"])
plt.savefig('images/2/mean_aprox_6_call.png')
plt.close()
...
plt.legend(["Path MC", "Gamma MC", "Gamma", "Gamma avg"])
plt.savefig('images/2/sd_aprox_6_call.png')
plt.close()
print("0")
...
# high barrier
option6 = Up_and_out_call(100.0, 0.05, 0.25, 0.05, 1,
                          100.0, 225, 0.05, 1000, 1, 200000)


if os.path.isfile("results/2/gamma_6.pickle"):
    gamma_abs_6, gamma_square_6 = pickle.load(
        open("results/2/gamma_6.pickle", "rb"))
else:
    gamma_abs_6, gamma_square_6 = gamma_test_barrier_call(
        100.0, 0.05, 0.25, 0.05, 1, 100.0, 225, 0.01)

    pickle.dump((gamma_abs_6, gamma_square_6),
                open("results/2/gamma_6.pickle", "wb"))
...
plt.legend(["Path MC", "Gamma MC", "Gamma", "Gamma avg"])
plt.savefig('images/2/mean_aprox_7_call.png')
plt.close()
...
plt.legend(["Path MC", "Gamma MC", "Gamma", "Gamma avg"])
plt.savefig('images/2/sd_aprox_7_call.png')
plt.close()
...
plt.savefig('images/2/ratio_k_call.png')
plt.close()
...
plt.xlabel("$N_S$")
plt.ylabel("Value of the ratio")
plt.savefig('images/2/ratio_v_call.png')
plt.close()
...
plt.xlabel("$N_S$")
plt.ylabel("Value of the ratio")
plt.savefig('images/2/ratio_h_call.png')
plt.close()
...
plt.ylabel("optimal_N*")
plt.legend()
plt.savefig('images/2/op_aprox_call.png')
plt.close()
...
plt.ylabel("optimal_N*")
plt.legend()
plt.savefig('images/2/op_dt_all_call.png')
plt.close()
...
plt.ylabel("optimal_N*")
plt.legend()
plt.savefig('images/2/op_dt_all_total_call.png')
plt.close()
